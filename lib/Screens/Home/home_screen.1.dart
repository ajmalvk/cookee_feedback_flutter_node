...
class _HomeState extends State<Home>{
  ...
  var _language_en_bg= Color(0xff49901F);
  ...
  var colors_nps_master = ["","0xFFEB3636","0xFFEB3636","0xFFEB3636","0xFFEB3636","0xFFEB3636","0xFFEB3636","0xFFFF8148","0xFFFF8148","0xFF49901F","0xFF49901F"];
  ...
  if(msg.toString()==AppLifecycleState.inactive.toString()){
                                                                                ...
                                                                                children: <Widget>[
                                                                                      ...
                                                                                      InkWell(  onTap:(){
                                                                                                       if(language_selected==1){
                                                                                                                                                            setState(() {
                                                                                                                                                                            language_selected=0;
                                                                                                                                                                            _language_en_bg= Color(0xff49901F);
                                                                                            ...
                                                                                            child: Container(
                                                                                                ...
                                                                                                decoration: BoxDecoration(
                                                                                                      ...
                                                                                                      borderRadius: BorderRadius.all( Radius.circular(5.0 * width_ratio),),
                                                                                                      boxShadow: [
                                                                                                        BoxShadow(
                                                                                      ...
                                                                                      InkWell(
                                                                                        onTap: (){
                                                                                          if(language_selected==0){
                                                                                                                                                                   setState(() {
                                                                                                                                                                                    ...
                                                                                                                                                                                    _language_fr_bg = Color(0xff49901F);
                                                                                        ...
                                                                                        child:  Container(
                                                                                                ...
                                                                                                child:Text(app_config.language2,
                                                                                                                          style: TextStyle(fontSize: 10*height_ratio,
                                                                                                                                            color: _language_fr_txt
                                                                                                                                              ),
                                                                                                                                                                  //maxLines: 1,
                                                                                                                        ),
                                                                                          ),
    ...
    Widget _loadClientLogo(){
        if(app_config.company_logo_exist){
              return Center(
                                                                  child: Image.network(app_config.company_logo,
                                                                                    fit: BoxFit.cover,
                                                                                )
                                                              );
          }
              ...
              return Center(
                                                                  child: Image.asset("assets/images/client-logo.png",
                                                                                    fit: BoxFit.cover,
                                                                                )
                                                              );
          }  
                ...
                if(page<app_config.questions.length){
                      ...
                      for(var qu in app_config.questions){
                            ...
                            for(var squ in qu.questions){
                                  ...
                                  cur={"QuestionTypeID":int.parse(qu.type),"QuestionID":int.parse(squ.id),"Answer":squ.answer,"FieldID":int.parse(squ.fieldId)};
                                  answers.add(cur);
                                  setState(() {
                      ...
                      for(var re in app_config.reasons){
                            if(re.selected){
                                  var cur={"ReasonQuestionID":re.questionId.toString(),"ReasonAnswerID":re.id.toString()};     
                                  reasons.add(cur);
                                  setState(() {
                      ...
                      var json_string=json.encode({"answers":answers,"reasonAnswers":reasons});
                                        ...
                                        children: <Widget>[
                                                Container(
                                                          ...
                                                          child: Text(
                                                                          ...
                                                                          style: TextStyle(fontSize: 50*width_ratio,
                                                                                          color: Colors.black,
  ...
  ///Over all Expierience
                              ...
                              child: Column(
                                            ...
                                            children: <Widget>[
                                                    Container(
                                                              ...
                                                              child: Center(
                                                                                            child: AutoSizeText(smily_question,
    ...
    Widget _overAllSectionSmilyThree(){
          ...
          var image_text1=app_config.questions[page].questions[0].rateText1Language1; 
          var image_text2=app_config.questions[page].questions[0].rateText2Language1;
          var image_text3=app_config.questions[page].questions[0].rateText3Language1;  
          //print(image_text3);
          if(app_config.questions[page].multipleLanguage==1 && language_selected==1){
    ...
    Widget _overAllSectionSmilyRow(String text,String image,String position,int smily_count){
                                                                              ...
                                                                              Container(
                                                                                      ...
                                                                                      child:  Center(
                                                                                                    child: AutoSizeText(text,
                                                                                                                          textAlign: TextAlign.center,
                                                                                                                          style: TextStyle(fontSize: 20.0*height_ratio,
                                                                                                                                          //color: th_colour
                                                                                                                                    ),
                                                                                                                      )
                                                                                                )    
    ...
    Widget _overAllSectionSmilyFive(){
              ...
              var image_text2=app_config.questions[page].questions[0].rateText2Language1;
              var image_text3=app_config.questions[page].questions[0].rateText3Language1;  
              var image_text4=app_config.questions[page].questions[0].rateText4Language1;
              var image_text5=app_config.questions[page].questions[0].rateText5Language1;  
              if(app_config.questions[page].multipleLanguage==1 && language_selected==1){
                      image_text1=app_config.questions[page].questions[0].rateText1Language2; 
                      image_text2=app_config.questions[page].questions[0].rateText2Language2;
                      image_text3=app_config.questions[page].questions[0].rateText3Language2;
    ...
    Widget _getNpsItemSingle(int position){
          ...
          return  InkWell(
                          onTap: (){
                                        setState(() {
                                                        app_config.questions[page].questions[0].answer = position.toString();
                                                        page++;
                                                                                });
                                  },
                          child: Container(
                            ...
                            //color: Colors.lime,
                                                                  child: Container(
                                                                                  ...
                                                                                  child: Center(
                                                                                                  child: AutoSizeText(position.toString(),
                                                                                                              style: TextStyle( fontSize: 25*height_ratio,
                                                                                                                                color: Colors.white,
                                                                                                                                fontWeight: FontWeight.bold
                                                                                                                              ),
    ...
    Widget _questionHeadTitles(){
          ...
          if(app_config.questions[page].questions[0].smileyCount=="5"){
                ...
                return Row(
                        children: <Widget>[
                              Container(
                                  margin: EdgeInsets.only(left:20.0*width_ratio,right:20.0*width_ratio),
    ...
    Widget _questionItemRow(int position){
          ...
          var question=app_config.questions[page].questions[position].questionLanguage1;
          if(app_config.questions[page].multipleLanguage==1 && language_selected==1){
                     question=app_config.questions[page].questions[position].questionLanguage2; 
                }
        ...
        return Container(
                                    ...
                                    child:   InkWell(
                                                  onTap: (){
                                                          ...
                                                          setState(() {
                                                                            app_config.questions[page].questions[position].answer=image_position.toString();                                    
                                                                                                         });
          ...
          if(profile_name){
                return Container(
                                                        ...
                                                        child:Material(
                                                                        ...
                                                                        child: TextFormField(
                                                                                              style: TextStyle(
                                                                                                          fontSize: 15.0*width_ratio,
                                                                                                          color: Colors.black
                                                                                                        ),
                                                                                              controller: _name_controller,
                                                                                              decoration: InputDecoration(
                                                                                                                          labelText: profile_name_text,
                                                                                                                          labelStyle: TextStyle(color: Colors.grey[400],fontSize: 13.0*width_ratio),
    ...
    Widget _personalDetailsQuestionsRow2Comment(){
          if(profile_comment){
                return Container(
                      margin: EdgeInsets.only(left: 10.0*width_ratio,top: 5*height_ratio),
                      height: MediaQuery.of(context).size.height*0.1,
          ...
          return Container(
                                                                                    ...
                                                                                    child:  FloatingActionButton(
                                                                                                onPressed: (){
                                                                                                        ...
                                                                                                        for(var pro in app_config.questions[page].questions){
                                                                                                              if(pro.fieldId=="1"){
                                                                                                                    app_config.questions[page].questions[i].answer=_name_controller.text;
                                                                                                                    _name_controller.text="";
                                                                                                                }
                                                                                                              else if(pro.fieldId=="3"){
                                                                                                                    app_config.questions[page].questions[i].answer=_email_controller.text;
                                                                                                                    _email_controller.text="";
                                                                                                                }
                                                                                                              else if(pro.fieldId=="2"){
                                                                                                                    app_config.questions[page].questions[i].answer=_phone_controller.text;
                                                                                                                    _phone_controller.text="";
                                                                                                                }
                                                                                                              else if(pro.fieldId=="4"){
                                                                                                                    app_config.questions[page].questions[i].answer=_address_controller.text;
                                                                                                                    _address_controller.text="";
                                                                                                                } 
                                                                                                              else if(pro.fieldId=="5"){
                                                                                                                    app_config.questions[page].questions[i].answer = _comment_controller.text;
                                                                                                ...
                                                                                                child: Icon(Icons.arrow_forward,
                                                                                                              size: MediaQuery.of(context).size.height*0.04*height_ratio,
                                                                                                            ),
                                                                                              ) ,
                                                                                  );
      }
                                                                                ...
                                                                                children: <Widget>[
                                                                                      ...
                                                                                      InkWell(  onTap:(){
                                                                                            ...
                                                                                            child: Container(
                                                                                                ...
                                                                                                child:Text(app_config.language1,
                                                                                                                          style: TextStyle(fontSize: 15*height_ratio,
                                                                                                                                            color: _language_en_txt
                                                                                                                                              ),
                                                                                                                                                                  //maxLines: 1,
                                                                                                                        ),
    ...
    Widget _overAllSectionSmilyRowLandscape(String text,String image,String position,int smily_count){
                                                                          ...
                                                                          children: <Widget>[
                                                                              ...
                                                                              Container(
                                                                                      ...
                                                                                      child:  Center(
                                                                                                    child: AutoSizeText(text,
                                                                                                                          textAlign: TextAlign.center,
                                                                                                                          style: TextStyle(fontSize: 25.0*height_ratio,
                                                                                                                                          //color: th_colour
                                                                                                                                    ),
                                                                                                                      )
                                                                                                )    
                  ...
                  return Column(
                              children: <Widget>[
                                      Container(
                                            ...
                                            child: Center(
                                                          child: AutoSizeText(smily_question,
                                                                              style: TextStyle(fontSize: 35*height_ratio),
                                                                              textAlign: TextAlign.center,
                                                                      ),
                                                      ),
                                        ),
                                              ...
                                              children: <Widget>[
                                                        Container(
                                                              ...
                                                              child: Container(
                                                                            ...
                                                                            child: AutoSizeText(start_text,
                                                                                        textAlign: TextAlign.center,
                                                                                        style: TextStyle(fontSize: 30.0*height_ratio,
                                                                                                        //color: th_colour
                                                                                                  ),
                                                                                    )   
                                                                        )
                          ...
                          child: Container(
                            ...
                            //color: Colors.lime,
                                                                  child: Container(
                                                                                  ...
                                                                                  child: Center(
                                                                                                  child: AutoSizeText(position.toString(),
                                                                                                              style: TextStyle( fontSize: 32*height_ratio,
                                                                                                                                color: Colors.white,
                                                                                                                                fontWeight: FontWeight.bold
                                                                                                                              ),
                                                                                                            )     ,
    ...
    Widget _personalDetailsQuestionsRow2CommentLandscape(){
          if(profile_comment){
                return Container(
                      margin: EdgeInsets.only(left: 10.0*width_ratio,top: 10*height_ratio),
                      height: MediaQuery.of(context).size.height*0.12,
    ...
    Widget  _personalDetailsButtonLandscape(){
          return Container(
                                                                                    ...
                                                                                    child:  FloatingActionButton(
                                                                                                ...
                                                                                                backgroundColor: Colors.grey[800],
                                                                                                child: Icon(Icons.arrow_forward,
                                                                                                              size: MediaQuery.of(context).size.height*0.06*height_ratio,
                                                                                                            ),
                                                                                              ) ,
                                                                                  );
      }
    ...
    Widget _questionItemRowSmileysSingleLandscape(int position,int image_position){
        var cur_image=app_config.questions[page].questions[position].imageUrl1;
        if(image_position==1){
            cur_image=app_config.questions[page].questions[position].imageUrl1;
          }
    ...
    Widget _questionItemRowSmileysSingleTickLandscape(int position,int image_position){
          if(app_config.questions[page].questions[position].answer==image_position.toString()){
                return Container(
                                                                            width: MediaQuery.of(context).size.width*0.9*0.45*0.3/5,
                                                                            height: MediaQuery.of(context).size.height*0.03, 
                             ...
                             alignment: Alignment.center,
                              child: Column(
                                            ...
                                            children: <Widget>[
                                                  ...
                                                  Container(
                                                              margin: EdgeInsets.only(bottom: 25.0*height_ratio,top: 35*height_ratio),
                                                              width: MediaQuery.of(context).size.width*0.5,
                                                              
                                                              child: Center(
                                                                                            child: AutoSizeText(reson_question,
                                                                                                                style: TextStyle(fontSize: 25*height_ratio),
                                                                                                                textAlign: TextAlign.center,
                                                                                                        ),
                                                                            ),
          ...
          return new GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return InkWell(
                                onTap: (){
                                            setState(() {
                                                                                          app_config.reasons[index].selected=!app_config.reasons[index].selected;
                                                                                        });
                                      },
                                child: Container(
                                              margin: EdgeInsets.all(10),
                                            ...
                                            child: Text(reason_text,
                                                              style: TextStyle(fontSize: 18*width_ratio,
                                                                                color: _text_colour
    ...
    Widget _reasoningSectionSmilyRow(String text,String image,String position,int smily_count){
                              ...
                              child: Column(
                                            ...
                                            children: <Widget>[
                                                  ...
                                                  Container(
                                                   ...
                                                   Container(
                                                              margin: EdgeInsets.only(bottom: 30.0*height_ratio,top: 50*height_ratio),
                                                              width: MediaQuery.of(context).size.width*0.5,
    ...
    Widget _reasoningSectionSmilyRowLandscape(String text,String image,String position,int smily_count){
